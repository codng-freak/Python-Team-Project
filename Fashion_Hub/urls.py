...
urlpatterns = [
    ...
    path('billing/', show, name="credit"),
    path('delete/<int:id>', destroy),
    path('exports/', shows, name="export_bill"),
    path('deletes/<int:id>', destroys),
    path('imports/', showss, name="import_bill"),
    path('deletess/<int:id>', destroyss),
    path('edit/<int:id>', edit, name="edit_export"),
    path('update/<int:id>', update, name="update_export"),
